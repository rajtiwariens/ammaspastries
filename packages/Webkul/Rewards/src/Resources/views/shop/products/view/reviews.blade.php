        ...
        <div class="container max-1180:px-5">
            ...
            <div v-else>
                ...
                <template v-else>
                    ...
                    @if (
                        core()->getConfigData('reward.general.general.reward-when-product-reviewed') 
                        && core()->getConfigData('reward.general.general.module-status')
                    )
                        <p class="text-[#858585] mb-2">
                            <b>@lang('rewards::app.shop.product.review.review-points', ['points' => core()->getConfigData('reward.general.general.reward-when-product-reviewed')])</b>
                        </p>
                    @endif
