                                    ...
                                    <div class="grid gap-2 max-w-max">
                                        ...
                                        <div class="flex gap-x-5 justify-between w-full">
                                            ...
                                            <div class="flex gap-x-5">
                                                ...
                                                <p class="text-sm">
                                                    {{ core()->formatPrice($invoice->giftcard_amount, $order->order_currency_code) }}
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid gap-2 max-w-max">
                                        ...
                                        <div class="flex gap-x-5 justify-between w-full">
                                            ...
                                            <div class="flex gap-x-5">
                                                ...
                                                <p class="text-sm">
                                                    {{ core()->formatPrice($refund->giftcard_amount, $order->order_currency_code) }}
                                                </p>
                                            </div>
                                        </div>
